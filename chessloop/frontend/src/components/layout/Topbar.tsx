    ...
    <header className="border-b border-ink-700 bg-ink-800/60 backdrop-blur">
      <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
        ...
        <nav className="flex items-center gap-4 text-sm">
          <Link to="/libraries" className="text-ink-200 hover:text-gold-400">Libraries</Link>
          <Link to="/practice" className="text-ink-200 hover:text-gold-400">Practice</Link>
          <Link to="/settings" className="text-ink-200 hover:text-gold-400">Settings</Link>
          {user && (
